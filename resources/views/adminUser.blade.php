		...
		<tbody>
			...
			foreach ($data['user'] as $user) { ?>
				<tr>
					...
					<td>
						<a href="/admin/user/form/<?php echo $user->id; ?>" class="btn btn-warning">Edit</a>
						<a href="/admin/user/hapus/<?php echo $user->id; ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini ?')">Hapus</a>
					</td>
				</tr>
			<?php 
				$no++;
